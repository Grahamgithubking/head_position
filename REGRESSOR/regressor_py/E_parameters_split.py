...
orthog=False # Set this to False if doing snrfcy!

snrtrue=False  # False = SNRCoil

split=False  #  Where SNR (Coil/True) is from a 'different' split session to FCy

snrfcy=True  # Only used when both orthog<false> and SNRCoil<True>
