...
def Edge_regressors(allfc_iu1, allsnr_iu1, nedges):
    ## Regression models for EACH edge (across 44 participants with < 2 > sessions):
    ...
    print()
    ## NOTE: param1 is the constant_value, param2 is the coefficient_x1
    np.save('/dhcp/fmri_anna_graham/GKgit/snr_npy/74691_params_snr_416_erode1_indep88.npy', parameters)
