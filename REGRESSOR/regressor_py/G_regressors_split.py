...
if __name__ == '__main__':
    ...
    orthog=False  #  Turn this of off if using snrfcy!
    ...
    splitA=False  # Where SNR (Coil/True) is from a 'different' split as FCy
    splitB=False

    snrfcya=True  # Where SNR-Coil is from the 'SAME' split as FCy
    snrfcyb=False
