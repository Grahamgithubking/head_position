...
do
    ...
    flirt -in /dhcp/scanner_positioning/resliced/${SUBJ}/${SESS}/${SUBJ}_${SESS}_preproc_bold-snr-erode1.nii.gz \
            -ref $REF \
            -out /dhcp/scanner_positioning/resliced/${SUBJ}/${SESS}/${SUBJ}_${SESS}_preproc_bold-snr-resliced-erode1.nii.gz \
            -applyxfm  

   # Reslice this subject's brainmask to template space:
    flirt -in /dhcp/scanner_positioning/resliced/${SUBJ}/${SESS}/${SUBJ}_${SESS}_task-rest_desc-preproc_space-bold_brainmask-erode1.nii.gz \
            -ref $REF \
            -out /dhcp/scanner_positioning/resliced/${SUBJ}/${SESS}/${SUBJ}_${SESS}_preproc_space-bold_brainmask-resliced-erode1.nii.gz \
            -applyxfm
            
#    # NOT DONE!!!! Binarise the resliced brainmask to a high threshold after the reslicing:     
#     fslmaths /dhcp/scanner_positioning/resliced/${SUBJ}/${SESS}/${SUBJ}_${SESS}_preproc_space-bold_brainmask-resliced-erode1.nii.gz \
#             -thr 0.9 -bin \
#             /dhcp/scanner_positioning/resliced/${SUBJ}/${SESS}/${SUBJ}_${SESS}_preproc_space-bold_brainmask-resliced-erode1.nii.gz \
